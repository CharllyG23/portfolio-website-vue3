<template>
  <section class="hero">
    <div class="hero-container">
      <div class="hero-container-content">
        <div class="flex items-center">
          <h1>Oiê</h1>
          <app-icons name="hands" :size="38" class="ml-5"></app-icons>
        </div>
        <h1>Sou Charlly</h1>
        <h1 class="hero-container-content-degraded">Frontend Developer</h1>
      </div>
      <div class="hero-container-content--subTitle">
        <p>Sou uma pessoa que adora criar coisas para a web. Uma desenvolvedora front-end motivada pela curiosidade com habilidades de design,
          Uma desenvolvedora front-end motivada pela curio com habilidades de design.
        </p>
      </div>
      <div class="flex items-center">
        <button>Download CV
    ...
    <div class="hero-arrow bounce">
      <app-icons name="down-arrow" :size="24"></app-icons>
    </div>
